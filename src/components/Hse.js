                ...
                <div class="grid grid-cols-12 grid-rows-1">
                    <div class="col-span-10">
                        <div class=" flex items-center justify-between row-span-1">
                            ...
                            <Link to="/" className="group w-24 h-20 flex flex-col text-center justify-center items-center my-4 mr-4 font-medium text-xs text-gray-400">
                                
                                <svg xmlns="http://www.w3.org/2000/svg" class="group-focus:text-red-500 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
                                </svg>
                                <p className="group-focus:text-gray-500">Formatos de Inspección de Seguridad</p>
                            </Link>
                            <Link to="/" className="group w-24 h-20 flex flex-col text-center justify-center items-center my-4 mr-4 font-medium text-xs text-gray-400">
                    ...
                    <div class=" col-span-2 flex flex-col justify-center border-l-2 border-red-500 mr-2">
                        ...
                        <div className="flex flex-col md:flex-row justify-end text-base font-bold text-gray-400 mt-6 mb-10 ">
                            <button className="group flex mr-2 items-center ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-4" viewBox="0 0 20 20" fill="currentColor">
                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                </svg>
                                <span className="text-base font-bold text-gray-400 group-focus:text-red-500">enviar</span>   
                            </button>
                            <button className="group flex ml-2 items-center ">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M2 9.5A3.5 3.5 0 005.5 13H9v2.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 15.586V13h2.5a4.5 4.5 0 10-.616-8.958 4.002 4.002 0 10-7.753 1.977A3.5 3.5 0 002 9.5zm9 3.5H9V8a1 1 0 012 0v5z" clip-rule="evenodd" />
                                </svg>
                                <span className="text-base font-bold text-gray-400 group-focus:text-red-500">descargar</span>
                            </button>
                        </div>
                        <div className="ml-2">
                            {/* w-64 */}
                            <div className="flex items-center ml-2 mb-1">
                                <input type="checkbox" class="rounded-full text-red-500 border-red-500 ring-0 focus:ring-0" id="dewey" name="drone" value="dewey"></input>
                                <span className="text-xs ml-1 font-medium text-gray-400 hover:text-red-500">
